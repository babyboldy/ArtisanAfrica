    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('SUPER_ADMIN', 'Super Administrateur'), ('ADMIN', 'Administrateur'), ('CLIENT', 'Client')], default='CLIENT', max_length=20)),
                ('is_active', models.BooleanField(default=True, help_text='Indique si ce compte est actif.', verbose_name='actif')),
