...
class BlogPostAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        # Si l'article est publié pour la première fois, envoyez une notification à l'auteur
        if 'status' in form.changed_data and obj.status == 'published':
            # Ici, vous pouvez implémenter l'envoi de notification à l'auteur
            # Par exemple:
            # send_notification(obj.author, f"Votre article '{obj.title}' a été publié !")
            pass
